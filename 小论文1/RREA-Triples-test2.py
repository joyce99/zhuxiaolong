...
lang = 'zh'
train_pair,dev_pair,adj_matrix,r_index,r_val,adj_features,rel_features,triples1,triples2,noisy1,noisy2,entityid1,entityid2,triples_pos1,triples_pos2 ,entity1,entity2,triplesinitial= load_data1('data/fr_en/',train_ratio=0.30)
...
rel_type,r_num= rfunc(triples+noisy, node_size)
kg=getkgdict(triples+noisy,r_num)
...
#         lensorthalf1 = int(lensorthalf * 0.7);
#         tempsorthalf = 0
#         x=0;y=0;
