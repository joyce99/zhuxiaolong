...
lang = 'zh'
train_pair,dev_pair,adj_matrix,r_index,r_val,adj_features,rel_features = load_data('data/dbp_wd/',train_ratio=0.30)
...
del adj_features;del rel_features;del rel_val;del ent_val;gc.collect()
...
for turn in range(7):
    ...
    if turn>0:
        ...
        for i in temp:
            ...
            if sim > threashoud:
                new_pairot.append(i)
        threashoud -= 0.05
        del tempair;del vec;gc.collect()
    ...
    del new_all;del new_paircsls;del new_pairot;gc.collect()