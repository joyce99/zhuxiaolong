...
lang = 'fr'
train_pair,dev_pair,adj_matrix,r_index,r_val,adj_features,rel_features,entity1,entity2,triples1,triples2 = load_dataliteral('data/zh_en/',train_ratio=0.30)
...
reldict={}
relset=set()
for i in triples1+triples2:
    reldict[i[1]]=[]
    relset.add(i[1])
for i in triples1+triples2:
    reldict[i[1]].append([i[0],i[2]])
