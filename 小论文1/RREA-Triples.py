...
lang = 'zh'
train_pair,dev_pair,adj_matrix,r_index,r_val,adj_features,rel_features,triples1,triples2,noisy1,noisy2,entityid1,entityid2,triples_pos1,triples_pos2 ,entity1,entity2,triplesinitial= load_data1('data/en_fr_15k_V1/',train_ratio=0.3)
...
train_pair=1*train_pair_initial
train_pair = np.concatenate([train_pair, np.array(new_paircsls)], axis=0)
templen=0
for i in train_pair:
